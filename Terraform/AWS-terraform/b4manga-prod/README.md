# B4 Manga Production - WordPress ASG Infrastructure

**Domain**: b4manga.com  
**Environment**: Production  
**Cloudflare Account**: it@b4manga.com  
**AWS Region**: us-west-1  

Specialized Terraform deployment for B4 Manga WordPress production environment with enterprise-grade high availability, Cloudflare DNS and SSL/TLS management.
...
## Quick Start - B4 Manga

### Windows (PowerShell)

```powershell
# Set environment variables first
$env:TF_VAR_rds_db_password = "YourSecurePassword123!@#"

# Deploy using B4 Manga script
.\Deploy-B4Manga.ps1 -Action plan
.\Deploy-B4Manga.ps1 -Action apply
```
...
# Deploy using B4 Manga script
chmod +x deploy-b4manga.sh
./deploy-b4manga.sh plan
./deploy-b4manga.sh apply
```
