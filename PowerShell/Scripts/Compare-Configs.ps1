...
function DevOps_Compare-Configs {
    ...
    $ConfigDiff = Invoke-Command  {
        $appsetting= Compare-Object -ReferenceObject (Get-Content H:\PS\outputs\$($computernameSource)_$CompareDate.$LoanAppModule.appsettings.json) -DifferenceObject (Get-Content H:\PS\outputs\$($computernameTarget)_$CompareDate.$LoanAppModule.appsettings.json)
